...
export const pageSectionClass = 'mb-4'
export const headingClass = 'text-bunker-green font-bold text-base mb-2 mt-4 first:mt-0'
export const pClass = 'text-gray-300 text-xs leading-relaxed mb-2'

/** Paginated chunks flattened into one scroll — keys preserved for React lists */
export const TERMS_CHUNKS: ReactNode[] = [
  <Fragment key="t1">
  ...
  <Fragment key="t10">
    ...
    <section className={pageSectionClass}>
      ...
      <p className={pClass}>Email Address: info@holdorfold.com</p>
      <p className={pClass}>
