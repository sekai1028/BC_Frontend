...
import { headingClass, pageSectionClass, pClass } from './termsChunks'

export const listClass = 'list-disc pl-5 text-gray-300 text-xs space-y-0.5 mb-2'

export const PRIVACY_CHUNKS: ReactNode[] = [
  <Fragment key="p1">
  ...
  <Fragment key="p2">
    ...
    <section className={pageSectionClass}>
      ...
      <p className={pClass}>The Company does not sell, rent, or lease its customer lists to third parties.</p>
      <p className={pClass}>
  ...
  <Fragment key="p5">
    <section className={pageSectionClass}>
      ...
      <p className={pClass}>Please note that we may not be able to comply with requests to delete your personal information if it is necessary to:</p>
      <ul className={listClass}>
  ...
  <Fragment key="p7">
    <section className={pageSectionClass}>
      ...
      <p className={pClass}>We may store your data on servers provided by third-party hosting vendors with whom we have contracted.</p>
    </section>
    <section className={pageSectionClass}>
